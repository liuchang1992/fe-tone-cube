      ...
      <div className="privacy-container">
        ...
        <div className="privacy-title-section">
          ...
          <Space size="middle" className="meta">
            <span>📅 版本：v1.0</span>
            <span>📌 更新日期：2026年7月9日</span>
            <span>⚡ 生效日期：2026年7月9日</span>
          </Space>
        </div>
        ...
        <div className="privacy-content">
          ...
          <ul>
            <li>
              <strong>输入文本内容</strong>：您在使用“语气转换”功能时输入的文本。
              <br />
              <Tag color="purple" style={{ marginTop: 4 }}>✓ 这些文本仅用于本次服务的实时响应，不会被用于模型训练。</Tag>
            </li>
            <li><strong>账户信息</strong>：如果您注册账号，我们会收集您的用户名和手机号（如开通手机登录）。</li>
          ...
          <ul>
            ...
            <li><strong>调用第三方API</strong>：为提供转换服务，我们会将您的输入文本传输至第三方大模型服务商（阿里云百炼）进行处理。</li>
            <li><strong>优化服务质量</strong>：在不识别您个人身份的前提下，分析服务使用情况以改进产品。</li>
          ...
          <ul>
            ...
            <li>
              <strong>存储期限</strong>：
              <ul>
                <li>转换过程中的输入文本不会长期保存。</li>
                <li>如果您登录并使用历史记录功能，记录将保存在您的账号下，您可随时手动删除。</li>
              </ul>
            </li>
          ...
          <ul>
            <li><strong>第三方API服务商</strong>：为提供语气转换服务，我们会将您的输入文本传输至阿里云百炼API。该服务商将按照其隐私政策处理数据。</li>
          ...
          <ul>
            ...
            <li><strong>删除权</strong>：您可以随时删除历史记录，或联系我们删除您的账户信息。</li>
          ...
          <Paragraph>
            ...
            <br />
            <Text strong>
              <MailOutlined /> 邮箱：<a href="mailto:your-email@example.com">18233383821@163.com</a>
            </Text>
          </Paragraph>
